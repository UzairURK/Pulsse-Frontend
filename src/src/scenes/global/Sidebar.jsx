...
const Item = ({ title, to, icon, selected, setSelected, setChild, left }) => {
  ...
  const textColor = title === 'Home' || title === 'User' || title === "Branches" || title === 'Settings' || title === 'Logout User' ? '#777777' : '#000000';
  const fontsize = title === 'Home' || title === 'User' || title === "Branches" || title === 'Settings' || title === 'Logout User' ? '14px' : '12px';
  const fontfamily = title === 'Home' || title === 'User' || title === "Branches" || title === 'Settings' || title === 'Logout User' ? 'Product Sans' : 'Noto Sans JP';
  const fontWeight = title === 'Home' || title === 'User' || title === "Branches" || title === 'Settings' || title === 'Logout User' ? 700 : 400;
  const lineheight = title === 'Home' || title === 'User' || title === "Branches" || title === 'Settings' || title === 'Logout User' ? '16.98px' : '17.38px'
  return (
    <Box>
      <MenuItem
